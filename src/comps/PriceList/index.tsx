      ...
      >
        ...
        <View className="WordSection1">
          ...
          <View className="MsoNormal">
            ...
            岁儿童发育风险评估服务（简称“婴儿发育评估”或“婴幼儿发育风险评估”，下文等同）的用户均应仔细阅读本服务条款，用户使用本服务的行为将被视为对服务条款全部内容的认可并接受。
          </View>

          <View className="MsoNormal">
            <Text>2</Text>、<Text>0-1</Text>
            岁儿童发育风险评估是一项综合性的评估服务。它融合了多项儿童神经发育评估工具，包括0~1岁52项神经运动检查（简化20项神经运动检查）、Vojta七项姿势反射检查，以及全身运动（GMs）自发姿势检查等，并利用脑科学领域最前沿的计算神经行为学分析方法。这项服务的核心目标在于早期识别那些在神经发育上稍显迟缓或异常的宝宝，以便为他们提供及时的干预和帮助。本服务的报告仅供参考，不能作为医疗诊断和治疗的直接依据。
          </View>

          <View className="MsoNormal">
            <Text>3</Text>、<Text>0-1</Text>
            岁儿童发育风险评估只是儿童发育健康咨询领域的一种初步方法，不能仅仅依靠评估结果判断小婴儿的脑发育状况，需要结合线下临床的全面诊断与评估。
          </View>
          ...
          <View className="MsoNormal">
            <Text>6</Text>
            、我们将在必要时修改服务条款，如果家长用户继续使用我们提供的服务，则被视为接受服务条款变动。我们保留修改服务条款的权利，不需知照家长用户或第三方。
          </View>
          ...
          <View className="MsoNormal">
            <Text>1</Text>、家长用户应该理解0-1岁儿童发育风险评估不属于医疗看诊，无法代替医生面诊，因此报告仅供参考，具体诊疗请一定要到医院由相关医生完成。
          </View>

          <View className="MsoNormal">
            <Text>2</Text>
            、我们不承担因家长用户自身过错、网络状况、通讯线路等任何技术原因或其他不可控原因而导致不能正常进行0-1岁儿童发育风险评估以及因此引起的损失，亦不承担任何相关法律责任。
          </View>
          
          <View className="MsoNormal">
            <Text>3</Text>
            、为了配合医院临床诊断需求，由互联网医疗服务提供方提供该项0-1岁儿童发育风险评估服务。该服务为医保外的自费服务项目，出具的费用收据及第三方提供的商业发票不能作为医保报销凭据，同时不支持商业保险报销。用户可自主选择是否购买和使用该服务。
          </View>
